...
async function seed() {
  ...
  await SiteConfig.create({
    ...
    socialLinks: {
      ...
      website: 'https://saiashirwad.com',
      dribbble: 'https://dribbble.com/anand',
    },
    heroHeading: "Hi, I'm Sai Ashirwad 👋",
    ...
    seoTitle: 'Sai Ashirwad — Full Stack Developer Portfolio',
    seoDescription: 'Sai Ashirwad is a full-stack developer specializing in React, Node.js, and modern web technologies. View projects, blog posts, and get in touch.',
  ...
  await Project.insertMany([
    {
      ...
      live: 'https://shop.saiashirwad.com',
      featured: true,
      published: true,
      order: 1,
    },
    ...
    },
    {
      ...
      live: 'https://dash.saiashirwad.com',
      featured: false,
      published: true,
      order: 4,
    },
  ...
  await Testimonial.insertMany([
    {
      ...
      content: 'Sai Ashirwad delivered our e-commerce platform ahead of schedule and exceeded all expectations. His attention to detail and ability to translate complex requirements into clean, functional code is remarkable. The site handles 10K+ daily transactions flawlessly.',
    ...
    },
    {
      ...
      content: 'Working with Sai Ashirwad was a fantastic experience. He not only built our entire backend infrastructure but also suggested improvements we hadn\'t thought of. His code quality is exceptional — clean, well-documented, and maintainable.',
      rating: 5, approved: true, featured: true,
    },
    {
      name: 'Sarah Chen',
      ...
      content: 'Sai Ashirwad took our Figma designs and turned them into a beautiful, responsive web app with smooth animations. He has a rare combination of technical skill and design sensibility. Highly recommended for any frontend project.',
      rating: 5, approved: true, featured: true,
    },
    {
      name: 'Mike Johnson',
      ...
      content: 'Sai Ashirwad set up our entire cloud infrastructure on AWS with Docker and Kubernetes. Our deployment time went from hours to minutes. Great communicator and delivers on time.',
    ...
    },
    {
      ...
      company: 'GrowthPulse',
      content: 'The portfolio website Sai Ashirwad built for us generates 3x more leads than our old site. The design is stunning, the SEO is on point, and the load times are incredibly fast.',
